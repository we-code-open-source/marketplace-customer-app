...
class _SignUpWidgetState extends StateMVC<SignUpWidget> {
  ...
  void initState() {
    ...
    // _con.user.phone_number=widget.routeArgument.param['phone'];
    super.initState();
  }
  @override
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TextFormField(
                        ...
                        onSaved: (input) => _con.user.phone_number = input.substring(1),
                        maxLength: 10,
                      ...
                      TextFormField(
                        ...
                        onSaved: (input) => _con.user.email = input,
                          validator: EmailValidator(errorText: S.of(context).should_be_a_valid_email),
                        decoration: InputDecoration(
                          labelText: S.of(context).email,
                          labelStyle: TextStyle(color: Theme.of(context).accentColor),
                          contentPadding: EdgeInsets.all(12),
                          hintText: 'me@sabek.ly',
                          hintStyle: TextStyle(color: Theme.of(context).focusColor.withOpacity(0.7)),
