                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                                    ...
                                    children: <Widget>[
                                      ...
                                      if (_con.carts[0].food.restaurant != null)
                                        if (_con.carts[0].food.restaurant.delivery_price_type == 'fixed')
                                          ...
                                          Helper.getDistancePrice(_con.carts[0].food.restaurant.deliveryFee,
                                              _con.carts[0].food.restaurant.distanceGoogle.distance.value/1000, context,
                                              style: Theme.of(context).textTheme.subtitle1)
                                        else if (_con.carts[0].food.restaurant.delivery_price_type == 'flexible' &&
                                              _con.carts[0].food.restaurant != null)
                                            Helper.getTimePrice(
                                                (_con.carts[0].food.restaurant.distanceGoogle.duration.value/60),
                                                (_con.carts[0].food.restaurant.distanceGoogle.distance.value/1000), context,
                                                style: Theme.of(context).textTheme.subtitle1,)
                                          else
                            ...
                            SizedBox(height: 3),
                            sett.coupon!=null && sett.coupon.id!=null
                            ?Row(
                              children: <Widget>[
                                Expanded(
                                  child: Text(
                                ...
                                Helper.getPrice( Helper.getPriceCoupon(_con.subTotal,_con.deliveryFee, sett.coupon), context, style: Theme.of(context).textTheme.subtitle1),
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Helper.getPrice(_con.total-Helper.getPriceCoupon(_con.subTotal,_con.deliveryFee, sett.coupon), context, style: Theme.of(context).textTheme.headline6)
                              ],
                            ),
                            SizedBox(height: 20),
                            SizedBox(
