...
class Setting {
  ...
  String ordersMaximum;
  String ordersMinimum;
  ...
  Setting.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      minimum_price = jsonMap['minimum_price'] ?? null;
      initial_price = jsonMap['initial_price'] ?? null;
      price_per_minute = jsonMap['price_per_minute'] ?? null;
      ordersMinimum = jsonMap['orders_minimum_value'] ?? null;
      ordersMaximum = jsonMap['orders_maximum_value'] ?? null;
      ...
      appVersionIOS = jsonMap['app_customer_version_ios'] ?? '';
      appVersionAndroid = jsonMap['app_customer_version_android'] ?? '';
      distanceUnit = jsonMap['distance_unit'] ?? 'km';
      enableVersion = jsonMap['enable_version'] == null || jsonMap['enable_version'] == '0' ? false : true;
      forceUpdateAndroid = jsonMap['app_customer_force_update_android'] == null || jsonMap['app_customer_force_update_android'] == '0' ? false : true;
      forceUpdateIOS = jsonMap['app_customer_force_update_ios'] == null || jsonMap['app_customer_force_update_ios'] == '0' ? false : true;
