...
Future<Stream<Cart>> getCart() async {
  ...
  final String url =
      '${GlobalConfiguration().getValue('api_base_url')}carts?myLon=${deliveryAddress.value.longitude}&myLat=${deliveryAddress.value.latitude}&${_apiToken}with=food;food.restaurant;extras&search=user_id:${_user.id}&searchFields=user_id:=';
print('++++++++++++++url+++++++++++++++++');
print(url);
print('++++++++++++++++++++++++++++++++++');
