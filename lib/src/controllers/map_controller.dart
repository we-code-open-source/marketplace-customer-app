...
class MapController extends ControllerMVC {
  ...
  void listenForNearRestaurants(Address myLocation, Address areaLocation) async {
    final Stream<Restaurant> stream = await getNearRestaurants(sett.deliveryAddress.value, sett.deliveryAddress.value);
    stream.listen((Restaurant _restaurant) {
      setState(() {
        topRestaurants.add(_restaurant);
      });
      Helper.getMarker(_restaurant).then((marker) {
        setState(() {
  ...
  void getCurrentLocation() async {
    try {
      ...
      print(currentAddress.isUnknown());
      print(currentAddress.latitude);
      print(currentAddress.longitude);
      print("++++++++++++++++++++++++++++++");
      setState(() {
