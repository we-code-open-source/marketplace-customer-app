...
import 'package:food_delivery_app/src/pages/addAddress.dart';
import 'package:food_delivery_app/src/pages/confirmation.dart';
import 'package:food_delivery_app/src/pages/forceUpdateView.dart';
import 'package:food_delivery_app/src/pages/notifications.dart';
import 'package:food_delivery_app/src/pages/reset_password.dart';
import 'src/pages/code_view.dart';
import 'src/pages/delivery_address.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
     ...
     case '/Confirmation':
        return MaterialPageRoute(builder: (_) => ConfirmationWidget(routeArgument: args as RouteArgument));
      case '/Tracking':
     ...
     //    return MaterialPageRoute(builder: (_) => ChooseScreen());
      ...
      case '/DeliveryAddresses':
        ...
        return MaterialPageRoute(builder: (_) => DeliveryAddressWidget());
      case '/DeliveryPickup':
