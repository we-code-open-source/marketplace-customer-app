...
class S {
  ...
  /// `Search for stores or foods`
  String get search_for_stores_or_foods {
    return Intl.message(
      'Search for stores or foods',
      name: 'search_for_stores_or_foods',
      desc: '',
      args: [],
    );
  }
  ...
  String get Please_choose_meals_from_the_same_restaurant {
    return Intl.message(
      'Please choose meals from the same restaurant',
      name: 'Please_choose_meals_from_the_same_restaurant',
      desc: '',
      args: [],
    );
  }
  ...
  String get driver_not_available {
    return Intl.message(
      'Driver not available',
      name: 'driver_not_available',
      desc: '',
      args: [],
    );
  }
  ...
  /// `You must add foods of the same stores choose one stores only!`
  String get you_must_add_foods_of_the_same_stores_choose_one {
    return Intl.message(
      'You must add foods of the same stores choose one store only!',
      name: 'you_must_add_foods_of_the_same_stores_choose_one',
      desc: '',
      args: [],
    );
  }
  ...
  String get reset_your_cart_and_order_meals_form_this_store {
    return Intl.message(
      'Reset your cart and order meals form this store',
      name: 'reset_your_cart_and_order_meals_form_this_store',
      desc: '',
      args: [],
    );
  }
  ...
  String get keep_your_old_meals_of_this_store {
    return Intl.message(
      'Keep your old meals of this store',
      name: 'keep_your_old_meals_of_this_store',
      desc: '',
      args: [],
    );
  }
  ...
  /// `D'ont have any item in your fava`
  String get dont_have_any_item_in_your_fav {
    return Intl.message(
      'D\'ont have any item in your favorites',
      name: 'dont_have_any_item_in_your_fav',
      desc: '',
      args: [],
    );
  }
  ...
  String get We_have_not_reached_your_area_yet {
    return Intl.message(
      'We haven\'t reached your area yet',
      name: 'We_have_not_reached_your_area_yet',
      desc: '',
      args: [],
    );
  }

  /// `But we are still working on expanding our service`
  String get but_we_are_still_working_on_expanding_our_service {
    return Intl.message(
      'But we are still working on expanding our service',
      name: 'but_we_are_still_working_on_expanding_our_service',
      desc: '',
      args: [],
    );
  }
  ...
  String get address_selected_successfully {
    return Intl.message(
      'Address selected successfully',
      name: 'address_selected_successfully',
      desc: '',
      args: [],
    );
  }

  /// `Address selected Error`
  String get address_selected_error {
    return Intl.message(
      'Address selected error',
      name: 'address_selected_error',
      desc: '',
      args: [],
    );
  }
  ...
  String get tell_us_about_this_drive {
    return Intl.message(
      'Tell us about this driver',
      name: 'tell_us_about_this_drive',
      desc: '',
      args: [],
    );
  }
  ...
  String get how_would_you_rate_this_driver {
    return Intl.message(
      'How would you rate this driver ?',
      name: 'how_would_you_rate_this_driver',
      desc: '',
      args: [],
    );
  }
  ...
  /// `The driver has been rated successfully`
  String get the_driver_has_been_rated_successfully {
    return Intl.message(
      'The driver has been rated successfully',
      name: 'the_driver_has_been_rated_successfully',
      desc: '',
      args: [],
    );
  }
  ...
  /// `To_add_a_new_address`
  String get To_add_a_new_address {
    return Intl.message(
      'To add a new address, click on the + sign',
      name: 'To_add_a_new_address',
      desc: '',
      args: [],
    );
  }
  ...
  String get featured_Restaurants {
    return Intl.message(
      'Featured Restaurants',
  ...
  /// `You can contact`
  String get you_can_contact {
    return Intl.message(
      'You can contact',
      name: 'you_can_contact',
      desc: '',
      args: [],
    );
  }
